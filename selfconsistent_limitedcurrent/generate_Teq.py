...
def generate_current_profile_fun(I_p,current_profile,radie,T_guess, tMax, Nt, n_D, n_B, B, a, r_0, Nr):
    T_initial = T_guess
    Tmin = 0 # min-temperatur
    Tmax = 5*T_initial # max-temperatur
    tol = 1e-2
    ...
    do = runiface(ds,'output_EQ.h5', quiet=False)
