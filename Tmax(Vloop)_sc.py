...
for x in V_loop_wall:
    ...
    ds_c.eqsys.E_field.setBoundaryCondition(ElectricField.BC_TYPE_PRESCRIBED, V_loop_wall=x, times=t)
...
np.savetxt('Sparad_data_sc/V_loop_wall.txt', V_loop_wall, delimiter=',')
