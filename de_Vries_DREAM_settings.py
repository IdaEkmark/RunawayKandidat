...
def run_DREAM(E,T_e,E1,Z_1,n_1,E2,Z_2,n_2,n_re0,B,r_0,R_0,A0,D0,r,Nr,t,tMax,Nt):
    #### DREAM settings ####
    ...
    #ds.eqsys.n_re.setCompton(Runaways.COMPTON_MODE_NEGLECT, photonFlux=0)
    ...
    ds.radialgrid.setMinorRadius(r_0)
    ds.radialgrid.setMajorRadius(R_0)
    ds.radialgrid.setWallRadius(r_0)
